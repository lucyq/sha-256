...
int main() {
    ...
    // string hmacKey;
    // int hmaclen
    // hmacReset(&hmac, SHA256 );
    
    // char *hmacKey = "BDABAB7857D30CB0F7FF995543DD0A7C214AA39A0272BD6087C4453798FEC457";
    // char keyArray[64];
    // strcpy(keyArray, hmacKey.c_str());

    // hmaclen = unhexstr(hmacKey);

    // printf('testing: %d', hmaclen);
